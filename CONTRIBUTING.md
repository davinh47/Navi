...
- Keep the [fixed report contract](docs/REPORTING.md) aligned with `report.py` and the packaged skill.
  Separate cumulative usage, retained records and current findings; never turn missing evidence into approval.
