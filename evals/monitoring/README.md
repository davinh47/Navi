...
Delivery-gap checks use the separate nine-case `evals/delivery_cases.json` fixture and
`tools/run_delivery_eval.py`; they are not part of this 30-case set or its seven-call harness.
See [delivery validation](../../docs/VALIDATION.md#delivery-gap-checks).
